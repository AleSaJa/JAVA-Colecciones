...
public class CourseService{
    ...
    public void displayCourseInformation(String courseId){
    	...
    	System.out.printf("\nId of Course: %s\nName of Course: %s\nCredits: %s\n",courses.get(courseId).id,courses.get(courseId).name,courses.get(courseId).credits);
    	//System.out.println(courses.get(i).toString());
    }

    public void displayStudentInformation(String studentId){
        //TODO implement so it shows the student name, id and list of enrolled courses
    	System.out.printf("\nId of Student: %s\nName of Student: %s\nEnrolled Courses: ",students.get(studentId).id,students.get(studentId).name);
    			for(Course j: students.get(studentId).getEnrolledCourses()) {
    				System.out.printf("%s ",j.name);
    			}
    			System.out.println("");
    ...
    public void displayTotalStudentCredits(String studentId) {
    	...
    	System.out.printf("\nStudent: %s -> Id: %s\nTotal Student Credits: %s",students.get(studentId).name,students.get(studentId).id,temp);
    }
}